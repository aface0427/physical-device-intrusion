...
class Application(tk.Tk):
    ...
    # 生成所有需要的图标
    def createICO(self):
        self.img1 = ImageTk.PhotoImage(Image.open('resource/defender.jpg'))
        self.img2 = ImageTk.PhotoImage(Image.open('resource/defender.jpg'))
        self.img3 = ImageTk.PhotoImage(Image.open('resource/defender.jpg'))
        self.img4 = ImageTk.PhotoImage(Image.open('resource/defender.jpg'))
    ...
    def createToolbar(self):
        ...
        ttk.Button(frame, width=20, image=self.img1, command=showdialog).grid(row=0, column=0, padx=1, pady=1,
                                                                              sticky=tk.E)
        ttk.Button(frame, width=20, image=self.img2, command=showdialog).grid(row=0, column=1, padx=1, pady=1,
                                                                              sticky=tk.E)
        ttk.Button(frame, width=20, image=self.img3, command=showdialog).grid(row=0, column=2, padx=1, pady=1,
                                                                              sticky=tk.E)
