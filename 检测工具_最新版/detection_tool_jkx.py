        ...
        try:
            ...
            while (cycle < cycle_max):
                if self.cycleFindDeviceFlag.get() == 0:
                    cycle += 1
                ListAddress = []
                for i in range(1, 255):  # 1-255地址轮询
...
class detectViewFrame(Frame):
    ...
    def timer_handler(self):
        ...
        if len(self.new_data) != 0:
            ...
            #     plt.xticks(my_x_ticks)
            #     plt.yticks(my_y_ticks)
            #     y_old = math.log(10,self.new_data[0])
            #     y = math.log(self.new_data[0])
...
class attackViewFrame(Frame):
    ...
    def setFrame_Init(self):
        ...
        # 监听按钮
        serialScanButton = tk.ttk.Button(self.set3Frame, text="开始监听", command=lambda: ThreadFunc(self.listen),
                                         width=10)
