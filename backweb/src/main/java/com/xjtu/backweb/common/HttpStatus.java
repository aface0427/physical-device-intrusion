package com.xjtu.backweb.common;
...
public class HttpStatus {
    ...
    public static HttpStatus NOSID = new HttpStatus(402,"sid未知");//200 执行失败
    ...
    public static HttpStatus ANSWER_AGAIN = new HttpStatus(477,"已存在回答");

    public static HttpStatus SMS_EXIST = new HttpStatus(450,"已经发送过短信");
    public static HttpStatus SMS_NO = new HttpStatus(451,"验证码错误");
//	业务返回
